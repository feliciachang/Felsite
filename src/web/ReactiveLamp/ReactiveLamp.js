  ...
  render(){
    return(
      ...
      image={
        ...
        <img style={{objectFit: "contain", height: 350, display: "block", margin: "auto"}} src="https://felswebsite.s3.amazonaws.com/lampgif.gif"/>
        </div>}
      />
      <BlogComponent
      number="02."
      ...
      image={
        <div style={{margin: "0 auto"}}>
        <img style={{objectFit: "contain", height: 350, display: "block", margin: "auto"}} src="https://felswebsite.s3.amazonaws.com/lampquick.gif"/>
        </div>}
      />
      <BlogComponent
      number="03."
      ...
      image={
        ...
        <img style={{objectFit: "contain", width: 350, display: "block", margin: "auto"}} src="https://felswebsite.s3.amazonaws.com/lampmotorsystem.jpg"/>
        </div>}
      />
      <BlogComponent
      number="04."
      ...
      image={
        <div style={{margin: "0 auto", align:"center"}}>
        <img style={{objectFit: "contain", width: 350, display: "block", margin: "auto"}} src="https://felswebsite.s3.amazonaws.com/lampstatic.JPG"/>
        </div>}
      />
      </div>
    )
