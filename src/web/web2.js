    ...
    return (
      <div style={{ maxWidth: "60vw" }}>
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/sinequanoncover.png"
          />
        </LazyLoad>
      </div>
    );
    ...
    return (
      <div style={{ maxWidth: "60vw" }}>
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/yercover.png"
          />
        </LazyLoad>
      </div>
    );
    ...
    return (
      <div style={{ maxWidth: "60vw" }}>
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/flossbankcover.png"
          />
        </LazyLoad>
      </div>
    );
    ...
    return (
      <div style={{ maxWidth: "60vw" }}>
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/Group+334.png"
          />
        </LazyLoad>
      </div>
    );
    ...
    return (
      <div style={{ maxWidth: "60vw" }}>
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/fieldkitcover.png"
          />
        </LazyLoad>
      </div>
    );
  ...
  render() {
    return (
      <div className="container">
        <img
          className="image"
          src="https://felswebsite.s3.amazonaws.com/SamsaraHome%402x.png"
        />
    ...
    return (
      <div className="container">
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/WeiboStar.png"
          />
        </LazyLoad>
        <div className="middle">
  ...
  render() {
    return (
      <div style={{ maxWidth: "60vw" }}>
        <LazyLoad offset={100}>
          <img
            style={{ display: "block", width: "68%", height: "auto" }}
            src="https://felswebsite.s3.amazonaws.com/lampcover.png"
          />
        </LazyLoad>
      </div>
    );
    ...
    return (
      <div className="container">
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/luxphoto.png"
          />
        </LazyLoad>
        <div className="middle">
          <div className="text">Lux Et Veritas</div>
          <div className="text2">
            an art installation in yale's becton cafe 2019
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div style={{ maxWidth: "60vw" }}>
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/internetchildgroup.png"
          />
        </LazyLoad>
      </div>
    );
      ...
      <div style={{ maxWidth: "60vw" }}>
        <LazyLoad offset={100}>
          <img
            ...
            className="image"
            src="https://felswebsite.s3.amazonaws.com/itjustsohappens.png"
          />
        </LazyLoad>
      </div>
    );
    ...
    return (
      <div className="container">
        <LazyLoad offset={100}>
          <img
            className="image"
            src="https://felswebsite.s3.amazonaws.com/WaterStar.png"
          />
        </LazyLoad>
        <div className="middle">
      ...
      <div>
        <div style={{ marginLeft: "4%", marginRight: "5%" }}>
          ...
          >
            ...
            <a
              style={{ textDecoration: "underline", color: "#1a1a1a" }}
              href="https://twopagesdoublespaced.substack.com/"
            >
              Substack
            </a>{" "}
            and{" "}
            <a
              style={{ textDecoration: "underline", color: "#1a1a1a" }}
              href="https://twitter.com/felchang"
            >
              Twitter
            </a>{" "}
            or feel free to send a{" "}
            <a
              style={{ textDecoration: "underline", color: "#1a1a1a" }}
              href="mailto:felicia.chang@yale.edu"
            >
              message
            </a>
            .
